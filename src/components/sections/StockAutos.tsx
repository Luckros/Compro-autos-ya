...
function AutoCard({ auto }: { auto: typeof AUTOS[0] }) {
  ...
  return (
    <article className="bg-white rounded-2xl overflow-hidden shadow-sm border border-gray-100 hover:shadow-lg transition-shadow duration-300 flex flex-col">
      ...
      <div className="relative bg-gray-100 aspect-[4/3] overflow-hidden">
        ...
        {/* Badge año */}
        <div className="absolute top-3 right-3 bg-brand-red text-white text-xs font-bold px-3 py-1 rounded-full">
          {auto.año}
        </div>
